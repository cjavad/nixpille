...
in
{
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      # Touchpad gestures (Hyprland 0.53+)
      gesture = [
        "3, horizontal, workspace" # 3-finger horizontal swipe - switch workspaces
        "3, up, fullscreen" # 3-finger swipe up - toggle fullscreen
        "3, down, fullscreen" # 3-finger swipe down - toggle fullscreen
      ];
    ...
    extraConfig = ''
      # Monitor config generated by hyprdynamicmonitors
